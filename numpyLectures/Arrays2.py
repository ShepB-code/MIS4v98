...
print("-----------------------------------------------   STEP FIVE  -----------------------------------------------")
cc_fees = salesArray * 0.02
total_fees = cc_fees.sum()
print(total_fees)
print()
...
print("-----------------------------------------------   STEP SIX  -----------------------------------------------")
profit_after_fees = salesArray - cc_fees
print(profit_after_fees)
print()

## Step 7: Print the sales only for the second and forth cash register
print("-----------------------------------------------   STEP SEVEN  -----------------------------------------------")
sales_second_fourth_register = salesArray[[1, 3], :]
print(sales_second_fourth_register)
print()
...
print("-----------------------------------------------   STEP NINE  -----------------------------------------------")
print("Before Correction:", salesArray[2])
salesArray[2, 3] = 20.14
print("After Correction:", salesArray[2])
print()
